...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── Auto-scroll smooth for entire page ── */
  ...
  .section-reveal {
    animation: sectionReveal 0.55s cubic-bezier(0.19,1,0.22,1) both;
  }

  /* ── Vibrant canvas border glow ── */
  @keyframes canvasGlow {
    0%,100% { box-shadow: 0 0 0 1.5px rgba(139,92,246,0.35), 0 0 24px rgba(139,92,246,0.12); }
    50%      { box-shadow: 0 0 0 1.5px rgba(34,211,238,0.45), 0 0 36px rgba(34,211,238,0.18); }
  }
  .canvas-idle { animation: canvasGlow 4s ease-in-out infinite; }

  /* ── Apple Dynamic Island pill ── */
  .dyn-island {
  ...
  /* ── Vibrant button pulse on hover ── */
  .btn-primary:not(:disabled):hover {
    transform: scale(1.025);
    box-shadow: 0 6px 32px rgba(139,92,246,0.55), 0 2px 8px rgba(59,130,246,0.3);
    ...
    <div style={{ position: "fixed", inset: 0, pointerEvents: "none", zIndex: 0, overflow: "hidden" }}>
      ...
      <motion.div
        ...
        style={{
          ...
          background: `radial-gradient(circle, ${T.purple}45 0%, transparent 68%)`,
        }}
      />
      ...
      <motion.div
        ...
        style={{
          ...
          background: `radial-gradient(circle, ${T.cyan}35 0%, transparent 68%)`,
        }}
      />
      {/* Mid pink orb */}
      <motion.div
        ...
        style={{
          ...
          background: `radial-gradient(circle, ${T.pink}28 0%, transparent 68%)`,
        }}
      />
      {/* Top-right blue orb */}
      <motion.div
        ...
        style={{
          ...
          background: `radial-gradient(circle, ${T.blue}30 0%, transparent 68%)`,
        }}
      />
      {/* Centre-bottom lime orb */}
      <motion.div
        animate={{ x: [0, 22, -18, 0], y: [0, -30, 14, 0] }}
        transition={{ duration: 40, repeat: Infinity, ease: "easeInOut", delay: 14 }}
        style={{
          position: "absolute", bottom: "8%", left: "35%",
          width: "200px", height: "200px", borderRadius: "50%",
          background: `radial-gradient(circle, ${T.lime}20 0%, transparent 68%)`,
        }}
      />
    </div>
  );
      ...
      {show && (
        ...
        >
          {loading ? (
            ...
            <>
              <span style={{ color: result.uncertain ? "#F472B6" : "#86EFAC" }}>
                {result.uncertain ? "⚠" : "✓"}
              </span>
              {result.uncertain
  ...
  return (
    ...
    >
      ...
      <p style={{ color: T.dim, fontSize: "0.58rem", opacity: 0.45, letterSpacing: "0.08em" }}>
        Neural Ink · EMNIST Balanced · PyTorch · v6
      </p>
    </motion.div>
  );
}
